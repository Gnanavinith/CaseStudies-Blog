      ...
      const mockData = [
        {
          ...
          company: "Tesla",
          excerpt: "How Tesla revolutionized automotive marketing through social media and word-of-mouth",
        ...
        {
          id: 2,
          title: "Nike: Digital-First Brand Transformation",
          company: "Nike",
          excerpt: "Nike's journey from traditional advertising to digital-first marketing strategies",
          category: "Digital Marketing",
          industry: "Sports",
          readTime: 7,
          rating: 4.8,
        ...
        {
          id: 3,
          title: "Coca-Cola: Social Media Marketing Success",
          company: "Coca-Cola",
          excerpt: "How Coca-Cola leveraged social media to connect with younger generations",
          category: "Digital Marketing",
          industry: "Beverages",
          readTime: 6,
          rating: 4.6,
            ...
            <article key={study.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-orange-600 font-medium">{study.industry}</span>
                ...
                {/* Action Button */}
                <button className="w-full bg-orange-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-orange-700 transition-colors duration-200 flex items-center justify-center group">
                  Read Case Study
