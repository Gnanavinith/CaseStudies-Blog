  ...
  useEffect(() => {
    const fetchCaseStudies = async () => {
      ...
      const mockData = [
        {
          id: 1,
          title: "Apple: iPhone Photography Campaign",
          company: "Apple",
          excerpt: "How Apple revolutionized smartphone photography marketing through stunning ad campaigns",
          category: "Ad Shoot",
          industry: "Technology",
          readTime: 9,
          rating: 4.9,
          ...
          featuredImage: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=250&fit=crop",
          publishedAt: "2024-01-25",
          difficulty: "Advanced"
        },
        {
          id: 2,
          title: "Nike: Just Do It Campaign Evolution",
          company: "Nike",
          excerpt: "The evolution of Nike's iconic Just Do It campaign through powerful visual storytelling",
          category: "Ad Shoot",
          industry: "Sports",
          readTime: 8,
          rating: 4.8,
          ...
          featuredImage: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=250&fit=crop",
          publishedAt: "2024-01-20",
          difficulty: "Intermediate"
        },
        {
          id: 3,
          title: "Coca-Cola: Happiness Factory Campaign",
          company: "Coca-Cola",
          excerpt: "How Coca-Cola created magical ad campaigns that captured the essence of happiness",
          category: "Ad Shoot",
          industry: "Beverages",
          readTime: 7,
          rating: 4.7,
          ...
          featuredImage: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=250&fit=crop",
            ...
            <article key={study.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-pink-600 font-medium">{study.industry}</span>
                ...
                {/* Action Button */}
                <button className="w-full bg-pink-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-pink-700 transition-colors duration-200 flex items-center justify-center group">
                  Read Case Study
